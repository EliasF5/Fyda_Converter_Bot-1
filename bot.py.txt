...
# Web Service Setup for Render (Port binding)
flask_app = Flask('')
...
LANG_TEXTS = {
    "om": {
        ...
        "deposit_btn": "💳 Deposit", "balance_btn": "💰 Balance", "settings_btn": "⚙️ Settings", "help_btn": "📞 Help", "send_fan_btn": "🔑 Send FAN / FIN",
    ...
    "am": {
        ...
        "deposit_btn": "💳 ዴፖዚት", "balance_btn": "💰 ሂሳብ ማሳያ", "settings_btn": "⚙️ ማስተካከያ", "help_btn": "📞 እርዳታ", "send_fan_btn": "🔑 Send FAN / FIN",
...
async def lang_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    return await send_main_menu_msg(context, user_id, prof)

async def send_main_menu_msg(context, user_id, prof):
...
async def handle_fan_state(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Menu text yoo ta'e gara main menu qajeelchi
    if fan_number in [texts["deposit_btn"], texts["balance_btn"], texts["settings_btn"], texts["help_btn"], texts["send_fan_btn"]]:
        return await handle_menu_options(update, context)
...
async def handle_otp_state(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Menu text yoo ta'e gara main menu qajeelchi
    if otp_code in [texts["deposit_btn"], texts["balance_btn"], texts["settings_btn"], texts["help_btn"], texts["send_fan_btn"]]:
        return await handle_menu_options(update, context)
